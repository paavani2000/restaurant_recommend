...
- 💬 **Sentiment Analysis**: Extracts insights from user reviews using NLP techniques  
- 🔐 **Blockchain Integration**: Uses Solidity smart contracts to store review data and reward users with loyalty points  
- 🎯 **Incentive System**: Fosters trust and engagement via transparent token-based rewards  

Technologies Used
- **Python**, **Flask API** – Backend and ML model serving  
- **Pandas**, **Scikit-learn**, **NLTK/VADER** – Data analysis & sentiment analysis  
- **Solidity**, **Remix**, **Ethereum Testnet** – Smart contract implementation  
- **Ganache**, **Web3.py** – Local blockchain testing and integration  
